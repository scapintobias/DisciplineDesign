...
export default function Servizi() {
	return (
		<>
			<SEO
				title='Servizi — DisciplineDesign'
				description='Servizi di UX architecture, modelli dati, flussi, prototipi e design system per software house e team di prodotto.'
				ogUrl='https://discipline.design/servizi'
